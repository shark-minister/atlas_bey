本稿の図は、ソフトウェアの画面キャプチャを除き、すべて私 "shark minister" が実物を元に書き起こしたものです。
これらの図の、無断での複製や配布、改変などはご遠慮ください。
また、本稿を参考に製作や運転をされる場合は、自己責任のもとで実施お願いします。
それによって生じたトラブル等については、いかなる責任も負いかねます。
...
<p align="center">
<img width="257" alt="Webクライアント画面" src="https://github.com/user-attachments/assets/404d4de1-38fd-4ce2-9c63-ce56d1050fad" />
</p>
...
ATLAS_AUTO_LAUNCHERを選んで〔ペア設定〕をクリックするとデバイスが接続されます。接続されると自動的にデバイスのパラメータが読み込まれます。
もしデバイスが2台のモーターを稼働させる状態になっている場合、以下の画面になります。

<p align="center">
<img width="344" alt="Webクライアント画面2" src="https://github.com/user-attachments/assets/637edc8b-9bc5-416e-a68e-205dd41b6dc4" />
</p>
